...
namespace fabrics.Services
{
    public class FaqService
    {
        ...
        public async Task<string> GetReplyAsync(string question)
        {
            ...
            if (question.Contains("نوع قماش  ") || question.Contains("مناسب") || question.Contains("كيف اختار"))
            ...
            if (question.Contains("انواع الصوف") || question.Contains("أيها يناسبني") || question.Contains("الفرق بين انواع الصوف"))
            ...
            if (question.Contains("توازن مثالي") || question.Contains("الدفء والوزن الخفيف"))
            ...
            if (question.Contains("مناسبة في الخريف"))
            ...
            if (question.Contains(" أفضل للشتاء") )
            ...
            if (question.Contains("معاينة المنتج قبل الاستلام ") || question.Contains("معاينة المنتج "))
            ...
            if (question.Contains("طرق الدفع"))
                return "نوفر عدة خيارات سهلة وآمنة للدفع:\r\n\r\n· 💳 الدفع عند الاستلام (مع رسوم عربون ١٠٪)\r\n· 📱 فودافون كاش\r\n· 📲 انستا باي";


            if (question.Contains("نظام الدفع عند الاستلام") || question.Contains("الدفع عند الاستلام"))
            ...
            if (question.Contains("رقم واتساب") || question.Contains("التواصل"))
